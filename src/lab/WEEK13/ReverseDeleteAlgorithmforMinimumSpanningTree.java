...
class ReverseDeleteAlgorithmforMinimumSpanningTree {
    ...
    static void primMST(int inputGraph[][], double logGraph[][]) {
        ...
        for (int count = 0; count < V - 1; count++) {
            ...
            for (int v = 0; v < V; v++) {
                // logGraph[u][v] is non-zero only for adjacent vertices of u
                // mstSet[v] is false for vertices not yet included in MST
                // Update the key only if logGraph[u][v] is smaller than key[v]
